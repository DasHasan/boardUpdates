...
import lwi.vision.web.rest.errors.EmailAlreadyUsedException;
import lwi.vision.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<UserEntity> createUser(@Valid @RequestBody AdminUserDTO userDTO) throws URISyntaxException {
